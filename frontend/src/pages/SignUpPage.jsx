        ...
        <div className="w-full max-w-md glass-card p-8 rounded-3xl border border-white/20 dark:border-zinc-800/30 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="form-control">
              <label className="label py-1">
                <span className="label-text font-semibold text-xs tracking-wide uppercase opacity-70">Full Name</span>
              </label>
            ...
            <div className="form-control">
              <label className="label py-1">
                <span className="label-text font-semibold text-xs tracking-wide uppercase opacity-70">Username</span>
              </label>
              <div className="glass-input-container">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-base-content/40 font-bold">
                  @
                </div>
                <input
                  type="text"
          ...
          <div className="text-center pt-2">
            <p className="text-sm text-base-content/60">
              ...
              <Link to="/login" className="font-semibold text-primary hover:underline hover:text-primary-focus transition-all">
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="space-y-4 py-2">
            <div className="chat chat-start animate-fade-in-up">
              ...
              <div className="chat-bubble glass-card border-none text-sm leading-relaxed p-3.5 rounded-2xl rounded-tl-none">
                Welcome to <span className="font-semibold text-primary">वार्तालाप</span>! Get ready for a premium real-time chatting experience. ⚡
              </div>
            </div>
            ...
            <div className="chat chat-end animate-fade-in-up delay-75">
              ...
              <div className="chat-bubble bg-gradient-to-tr from-primary to-indigo-600 text-primary-content text-sm leading-relaxed p-3.5 rounded-2xl rounded-tr-none shadow-md">
                Can I customize themes and toggle between light and dark modes?
              </div>
            </div>
            ...
            <div className="chat chat-start animate-fade-in-up delay-150">
              ...
              <div className="chat-bubble glass-card border-none text-sm leading-relaxed p-3.5 rounded-2xl rounded-tl-none">
                Absolutely! We support multiple vibrant palettes and automatic dark/light theme switching. Try it now!
              </div>
            </div>
          </div>
