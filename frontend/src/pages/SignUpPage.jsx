    ...
    <div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-base-content/40 font-bold">
                  @
                </div>
                <input
                  type="text"
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-base-200 p-12">
        <div className="max-w-md text-center space-y-6">
          ...
          <p className="text-base-content/60">
            Connect with friends, share media, and chat in real-time. Customize your look with various themes!
          </p>
        </div>
      </div>
    </div>
